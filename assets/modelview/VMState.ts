...
import {_decorator, Color, color, Enum, Node} from 'cc';
...
export default class VMState extends VMBase {
    ...
    /**更新单个节点的状态 */
    private setNodeState(node: any, checkState?: boolean) {
        ...
        switch (n) {
            ...
            case a.NODE_VISIBLE:
                ...
                break;
            case a.NODE_COLOR:
                node.color = check ? this.valueActionColor : color(255, 255, 255);
                break;
            case a.NODE_OPACITY:
